//referenced from mahout library
 ...
 * arguments.</p>
 */
public final class CFR extends AbstractJob {
  ...
  private static final String USER_ITEM_FILE = "userItemFile";
...
//  @Override
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new CFR(), args);
  }
}
